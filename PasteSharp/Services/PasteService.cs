...
namespace PasteSharp.Services
{
    public class PasteService : IDisposable
    {
        ...
        public async Task<string> CreatePasteAsync(string apiKey, string content, bool unlisted, string title, string expire)
        {
            ...
            post.Add(new KeyValuePair<string, string>("api_paste_expire_date", expire));
